...
// UserRepository is what userRepository can do
...
func (db *userConnection) DeleteUser(userID int64) int64 {
	var user entity.User
	return db.connection.Delete(user, userID).RowsAffected
}
